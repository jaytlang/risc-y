...
class RVMachine:
        ...
        def execute(self):
                ...
                if self.opcode==opcode_LOAD and self.funct3==funct3_LW  : self.executeLw(); self.lws+=1
                ...
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BEQ  : self.executeBeq(); self.branches+=1
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BNE  : self.executeBne(); self.branches+=1
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BLT  : self.executeBlt(); self.branches+=1
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BGE  : self.executeBge(); self.branches+=1
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BLTU : self.executeBltu(); self.branches+=1
                elif self.opcode==opcode_BRANCH and self.funct3==funct3_BGEU : self.executeBgeu(); self.branches+=1
                elif self.opcode==opcode_JALR : self.executeJalr(); self.jumps+=1
                elif self.opcode==opcode_JAL  : self.executeJal(); self.jumps+=1
